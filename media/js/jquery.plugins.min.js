...
(function(a){var b=navigator.userAgent.toLowerCase(),c=b.match(/(iphone|ipod|ipad)/),d={init:function(b){return this.each(function(){function m(b){!a.browser.msie||document.documentMode>=9||event.button||(l=!1),b.which!==1||l||(b.which=0)}function n(a,b){var c=a.offset(),d=b.pageX-c.left,e=100*d/(a.width()+1);0>e&&(e=0),e>100&&(e=100),g=a.parents(".panzer").data("panzer"),g.audio.volume=e/100}var d=a(this);if(d.is("audio")){var e=a.extend({layout:"mini",theme:"dark",expanded:!1,cover:"",pauseothers:!0,showduration:!1,showvolume:!1,volume:100,title:""},b);0>e.volume&&(e.volume=0),e.volume>100&&(e.volume=100);var d=a(this),f=d.get(0),g=d.data("panzer");if(!g){var h="";if(e.layout=="big"&&(h=" panzer-big"),h+=e.theme=="light"?" panzer-light":e.theme=="dark"?" panzer-dark":" panzer-custom",e.expanded&&(h+=" panzer-expand"),e.pauseothers&&(h+=" pause-others"),this.canPlayType){if(controls='<div class="controls"><span class="play"><em></em></span></div><div class="progress-wrapper"><div class="progress"><div class="elapsed" style="width:0;display:none"></div></div></div>',e.showduration){var i,j;i=Math.floor(f.duration/60),i=isNaN(i)?"00":i>=10?i:"0"+i,j=Math.floor(f.duration%60),j=isNaN(j)?"00":j>=10?j:"0"+j,controls+=i>100?'<span class="duration small">'+i+":"+j+"</span>":'<span class="duration">'+i+":"+j+"</span>",h+=" show-duration"}e.showvolume&&(controls+='<div class="volume-wrapper"><span></span><div class="volume"><div class="set" style="width:'+e.volume+'%"></div></div></div>',h+=" show-volume")}else{var k=d.attr("src");k===void 0&&(k=d.children("source:first").attr("src")),k===void 0?(controls='<strong class="alert">Please specify an audio source file.</strong>',h+=" panzer-unsupported"):(controls='<div class="controls"><a class="download" href="'+k+'" title="Download File"><em></em></a></div><strong class="alert">Download Audio File</strong>',h+=" panzer-download")}if(album_cover=e.cover!=""?'<div class="cover"><img src="'+e.cover+'" alt="" /></div>':d.data("cover")?'<div class="cover"><img src="'+d.data("cover")+'" alt="" /></div>':"",song_title=e.title&&0!==e.title.length?'<div class="title">'+e.title+"</div>":d.data("title")?'<div class="title">'+d.data("title")+"</div>":"",$player=a('<div class="panzer'+h+'">'+album_cover+'<div class="player">'+controls+"</div>"+song_title+"</div>"),d.after($player).data("panzer",{target:d,audio:f,player:$player,loc:d.prev()}),c?d.css({position:"absolute",top:-9999,width:0,height:0,display:"none",visibility:"hidden",overflow:"hidden"}):d.detach(),$player.data("panzer",{audio:f}),this.canPlayType){if(a(".play",$player).click(function(){a(this).hasClass("play")&&a(".panzer.pause-others,.panzerlist.pause-others").each(function(){var b=a(this).data("panzer");b&&b.audio.pause();c=a(this).find('a.active').data('panzerlist');c&&c.audio.pause();}),g=a(this).parents(".panzer").data("panzer"),g.audio.paused?g.audio.play():g.audio.pause()}),f.addEventListener("play",function(){g=a(this).data("panzer"),a(".play",g.player).toggleClass("play pause")}),f.addEventListener("pause",function(){g=a(this).data("panzer"),a(".pause",g.$player).toggleClass("play pause")}),f.addEventListener("ended",function(){g=a(this).data("panzer"),g.audio.pause()}),f.addEventListener("timeupdate",function(){g=a(this).data("panzer");var b=g.audio.currentTime*100/g.audio.duration;if(!isNaN(b)){var c,d,e;c=Math.floor(g.audio.currentTime/60),d=isNaN(c)?"00":c>=10?c:"0"+c,e=Math.floor(g.audio.currentTime%60),e=isNaN(e)?"00":e>=10?e:"0"+e,!isNaN(c)&&c>99&&a("span.duration",g.player).addClass("small"),a("span.duration",g.player).html(d+":"+e),b==0?a(".elapsed",g.player).hide().css("width",0):a(".elapsed",g.player).show().css("width",b+"%")}}),e.showvolume){f.addEventListener("volumechange",function(){g=a(this).data("panzer");var b=g.audio.volume*100;b==0?a(".volume .set",g.player).hide().css("width",0):a(".volume .set",g.player).show().css("width",b+"%")}),f.volume=e.volume/100;var l=!1;a(".volume").mousedown(function(b){b.which===1&&(l=!0,n(a(this),b))}),a(".volume").mouseup(function(a){a.which===1&&(l=!1)}),a(".volume").mousemove(function(b){m(b),b.which==1&&b.button==0&&n(a(this),b)})}a(".progress").click(function(b){var c=a(this).offset(),d=b.pageX-c.left,e=100*d/(a(this).width()+1);0>e&&(e=0),e>100&&(e=100),g=a(this).parents(".panzer").data("panzer");var f=Math.round(g.audio.duration/100*e);g.audio.readyState===0?g.audio.addEventListener("canplay",function(){g=a(this).data("panzer"),g.audio.currentTime=f}):g.audio.currentTime=f})}}}})},destroy:function(){return this.each(function(){var b=a(this),d=b.data("panzer");d&&(c?b.removeAttr("style"):d.loc&&d.loc.after(b),d.player.remove(),b.removeData("panzer").removeAttr("style"))})}};a.fn.panzer=function(b){return d[b]?d[b].apply(this,Array.prototype.slice.call(arguments,1)):typeof b!="object"&&b?(a.error("Method "+b+" does not exist on jQuery.panzer"),void 0):d.init.apply(this,arguments)}})(jQuery);

/* Panzer HTML5 Audio Playlist by Liviu Holhos */
(function(a){var b=navigator.userAgent.toLowerCase(),c=b.match(/(iphone|ipod|ipad)/),d={init:function(b){function g(){data=a(this).data("panzerlist"),a(".play",data.player).toggleClass("play pause")}function h(){data=a(this).data("panzerlist"),a(".pause",data.$player).toggleClass("play pause")}function i(){if(data=a(this).data("panzerlist"),data.audio.pause(),data.player.hasClass("auto-advance")){if($active=data.player.find(".list a.active"),$active.is(":last-child")){if(!data.player.hasClass("repeat-all"))return;$next=data.player.find(".list a:first")}else $next=$active.next("a");$next.trigger("click")}}function j(b){if(b.preventDefault(),$this=a(this),a(".panzerlist.pause-others .list a.active").not($this).each(function(){var b=a(this).data("panzerlist");b&&(b.audio.paused||b.audio.pause())}),data=a(this).parents(".panzerlist").find(".list a.active").data("panzerlist"),$isactive=a(this).hasClass("active"),data.audio.paused||($isactive||data.audio.pause(),data.audio.currentTime=0),$isactive)data.audio.play();else{try{data.audio.currentTime=0}catch(c){}data=a(this).data("panzerlist"),a(this).parents(".panzerlist").find(".list a").removeClass("active"),a(this).addClass("active"),data.audio.play()}}var d=a.extend({layout:"mini",theme:"custom",expanded:!1,title:"",cover:"",volume:100,show_prev_next:!0,show_list:!1,pause_others:!0,auto_start:!1,auto_advance:!0,repeat_all:!0,outdated_text:"Browser is outdated, but you can still download and listen to the audio files on your computer.",auto_numbering:!1},b);0>d.volume&&(d.volume=0),d.volume>100&&(d.volume=100);var e="";"big"==d.layout&&(e=" panzerlist-big"),e+=" panzerlist-"+d.theme,d.expanded&&(e+=" panzerlist-expand"),d.show_prev_next||(e+=" hide-prev-next"),d.show_list||(e+=" hide-list"),d.pause_others&&(e+=" pause-others"),d.auto_advance&&(e+=" auto-advance"),d.repeat_all&&(e+=" repeat-all");var f=document.createElement("audio");return f.canPlayType?(controls='<div class="controls"><span class="play"><em></em></span><div class="prev-next"><span class="prev"></span><span class="next"></span></div></div>',song_title=d.title&&0!==d.title.length?'<div class="title">'+d.title+"</div>":"",""!=d.cover?(album_cover='<div class="cover"><img src="'+d.cover+'" alt="" /></div>',d.show_list&&(e+=" hide-list")):album_cover="",$player=a('<div class="panzerlist'+e+'">'+song_title+album_cover+'<div class="list"></div><div class="player">'+controls+"</div></div>"),a(".play",$player).click(function(){a(this).hasClass("play")&&(a(".panzerlist.pause-others .list a.active").each(function(){var b=a(this).data("panzerlist");b&&(b.audio.paused||b.audio.pause())}),a(".panzer.pause-others").each(function(){var b=a(this).data("panzer");b&&b.audio.pause()})),data=a(this).parents(".panzerlist").find(".list a.active").data("panzerlist"),data.audio.paused?data.audio.play():data.audio.pause()}),a(".prev,.next",$player).click(function(){if($active=a(this).parents(".panzerlist").find(".list a.active"),data=$active.data("panzerlist"),a(this).hasClass("prev"))if($active.is(":first-child")){if(!data.player.hasClass("repeat-all"))return;$next=data.player.find(".list a:last")}else $next=$active.prev("a");else if($active.is(":last-child")){if(!data.player.hasClass("repeat-all"))return;$next=data.player.find(".list a:first")}else $next=$active.next("a");data.audio.pause(),data.audio.currentTime=0,$next.trigger("click")}),$i=0,this.each(function(){var b=a(this),e=b.get(0);b.is("audio")&&(b.data("panzerlist")||(e.volume=d.volume/100,e.addEventListener("play",g),e.addEventListener("pause",h),e.addEventListener("ended",i),$i++,$el=a('<a href="'+b.children("source:first").attr("src")+'"'+(1==$i?' class="active"':"")+">"+(d.auto_numbering?$i+". ":"")+b.attr("title")+"</a>").data("panzerlist",{audio:e,player:$player}).click(j),a(".list",$player).append($el),b.after($player).data("panzerlist",{audio:e,player:$player,elem:$el,loc:b.prev()}),c?b.css({position:"absolute",top:-9999,width:0,height:0,display:"none",visibility:"hidden",overflow:"hidden"}):b.detach()))}),d.auto_start&&a(".list a:first",$player).trigger("click")):(e=" panzerlist-unsupported","big"==d.layout&&(e+=" panzerlist-big"),e+=" panzerlist-"+d.theme,d.expanded&&(e+=" panzerlist-expand"),song_title=d.title&&0!==d.title.length?'<div class="title">'+d.title+"</div>":"",""!=d.cover?(album_cover='<div class="cover"><img src="'+d.cover+'" alt="" /></div>',d.show_list&&(e+=" hide-list")):album_cover="",$player=a('<div class="panzerlist'+e+'">'+song_title+album_cover+'<div class="list"></div><div class="player"><strong class="alert">'+d.outdated_text+"</strong></div></div>"),$i=0,this.each(function(){var b=a(this);b.is("audio")&&(b.data("panzerlist")||($i++,$el=a('<a href="'+b.children("source:first").attr("src")+'"'+">"+$i+". "+b.attr("title")+"</a>").data("panzerlist",{player:$player}),a(".list",$player).append($el),b.after($player).data("panzerlist",{player:$player,elem:$el,loc:b.prev()}).detach()))})),this},destroy:function(){return this.each(function(){var b=a(this),d=b.data("panzerlist");d&&(c?b.removeAttr("style"):d.loc&&d.loc.after(b),d.player.remove(),b.removeData("panzerlist").removeAttr("style"),d=null)})}};a.fn.panzerlist=function(b){return d[b]?d[b].apply(this,Array.prototype.slice.call(arguments,1)):"object"!=typeof b&&b?(a.error("Method "+b+" does not exist on jQuery.panzerlist"),void 0):d.init.apply(this,arguments)}})(jQuery);

/* jquery.nicescroll 2.9.7 */
(function(b){function i(){var a=document.getElementsByTagName("script"),b=a[a.length-1].src.split("?")[0];return b.split("/").length>0?b.split("/").slice(0,-1).join("/")+"/":""}function q(a,b,c){for(var d=0;b.length>d;d++)c(a,b[d])}var c=!1,d=!1,f=5e3,g=2e3,h=b,j=i(),k=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||!1}(),l=function(){return window.cancelRequestAnimationFrame||window.webkitCancelRequestAnimationFrame||window.mozCancelRequestAnimationFrame||window.oCancelRequestAnimationFrame||window.msCancelRequestAnimationFrame||!1}(),m=function(a,b){function r(){var a=["-moz-grab","-webkit-grab","grab"];(e.ischrome||e.isie)&&(a=[]);for(var b=0;a.length>b;b++){var c=a[b];if(m.style.cursor=c,m.style.cursor==c)return c}return"url(http://www.google.com/intl/en_ALL/mapfiles/openhand.cur),n-resize"}function t(a,b,c){var d=a.css(b),f=parseFloat(d);if(isNaN(f)){f=s[d]||0;var g=f==3?c?e.win.outerHeight()-e.win.innerHeight():e.win.outerWidth()-e.win.innerWidth():1;return e.isie8&&f&&(f+=1),g?f:0}return f}var e=this;if(this.version="2.9.7",this.name="nicescroll",this.me=b,this.opt={doc:h("body"),win:!1,zindex:9e3,cursoropacitymin:0,cursoropacitymax:1,cursorcolor:"#424242",cursorwidth:"5px",cursorborder:"1px solid #fff",cursorborderradius:"5px",scrollspeed:60,mousescrollstep:40,touchbehavior:!1,hwacceleration:!0,usetransition:!0,boxzoom:!1,dblclickzoom:!0,gesturezoom:!0,grabcursorenabled:!0,autohidemode:!0,background:"",iframeautoresize:!0,cursorminheight:20,preservenativescrolling:!0,railoffset:!1,bouncescroll:!1,spacebarenabled:!0,railpadding:{top:0,right:0,left:0,bottom:0},disableoutline:!0},a)for(var i in e.opt)a[i]!==void 0&&(e.opt[i]=a[i]);this.doc=e.opt.doc,this.iddoc=this.doc&&this.doc[0]?this.doc[0].id||"":"",this.ispage=/BODY|HTML/.test(e.opt.win?e.opt.win[0].nodeName:this.doc[0].nodeName),this.haswrapper=e.opt.win!==!1,this.win=e.opt.win||(this.ispage?h(window):this.doc),this.docscroll=this.ispage&&!this.haswrapper?h(window):this.win,this.body=h("body"),this.iframe=!1,this.isiframe=this.doc[0].nodeName=="IFRAME"&&this.win[0].nodeName=="IFRAME",this.istextarea=this.win[0].nodeName=="TEXTAREA",this.onmousedown=!1,this.onmouseup=!1,this.onmousemove=!1,this.onmousewheel=!1,this.onkeypress=!1,this.ongesturezoom=!1,this.onclick=!1,this.view=!1,this.page=!1,this.observer=!1,this.scroll={x:0,y:0},this.scrollratio={x:0,y:0},this.cursorheight=20,this.scrollvaluemax=0,this.scrollmom=!1;do this.id="ascrail"+g++;while(document.getElementById(this.id));this.rail=!1,this.cursor=!1,this.cursorfreezed=!1,this.zoom=!1,this.zoomactive=!1,this.hasfocus=!1,this.hasmousefocus=!1,this.visibility=!0,this.locked=!1,this.hidden=!1,this.nativescrollingarea=!1,this.events=[],this.saved={},this.delaylist={},this.synclist={},this.lastdelta=0;var m=document.createElement("DIV");if(this.isopera="opera"in window,this.isie="all"in document&&"attachEvent"in m&&!this.isopera,this.isieold=this.isie&&!("msInterpolationMode"in m.style),this.isie7=!(!this.isie||this.isieold||"documentMode"in document&&document.documentMode!=7),this.isie8=this.isie&&"documentMode"in document&&document.documentMode==8,this.isie9=this.isie&&"performance"in window&&document.documentMode>=9,this.isie9mobile=/iemobile.9/i.test(navigator.userAgent),this.isie7mobile=!this.isie9mobile&&this.isie7&&/iemobile/i.test(navigator.userAgent),this.ismozilla="MozAppearance"in m.style,this.ischrome="chrome"in window,this.cantouch="ontouchstart"in document.documentElement,this.hasmstouch=window.navigator.msPointerEnabled||!1,this.isios=this.cantouch&&/iphone|ipad|ipod/i.test(navigator.platform),this.isios4=this.isios&&!("seal"in Object),e.opt.hwacceleration){this.trstyle=window.opera?"OTransform":document.all?"msTransform":m.style.webkitTransform!==void 0?"webkitTransform":m.style.MozTransform!==void 0?"MozTransform":!1,this.trstyle&&m.style[this.trstyle]===void 0&&(this.trstyle=!1),this.hastransform=this.trstyle!=0,this.hastransform&&(m.style[this.trstyle]="translate3d(1px,2px,3px)",this.hastranslate3d=/translate3d/.test(m.style[this.trstyle])),this.transitionstyle=!1,this.prefixstyle="",this.transitionend=!1;for(var o=["transition","webkitTransition","MozTransition","OTransition","msTransition","KhtmlTransition"],p=["","-webkit-","-moz-","-o-","-ms-","-khtml-"],q=["transitionend","webkitTransitionEnd","transitionend","oTransitionEnd","msTransitionEnd","KhtmlTransitionEnd"],i=0;o.length>i;i++)if(o[i]in m.style){this.transitionstyle=o[i],this.prefixstyle=p[i],this.transitionend=q[i];break}this.hastransition=this.transitionstyle}else this.trstyle=!1,this.hastransform=!1,this.hastranslate3d=!1,this.transitionstyle=!1,this.hastransition=!1,this.transitionend=!1;this.cursorgrabvalue="",e.opt.grabcursorenabled&&e.opt.touchbehavior&&(this.cursorgrabvalue=r()),m=null,this.ishwscroll=e.hastransform&&e.opt.hwacceleration&&e.haswrapper,this.delayed=function(a,b,c){var d=e.delaylist[a],f=(new Date).getTime();return d&&d.tt?!1:(d&&d.last+c>f&&!d.tt?e.delaylist[a]={last:f+c,tt:setTimeout(function(){e.delaylist[a].tt=0,b.call()},c)}:d&&d.tt||(e.delaylist[a]={last:f,tt:0},setTimeout(function(){b.call()},0)),void 0)},this.requestSync=function(){e.onsync||(k(function(){e.onsync=!1;for(name in e.synclist){var a=e.synclist[name];a&&a.call(e),e.synclist[name]=!1}}),e.onsync=!0)},this.synched=function(a,b){e.synclist[a]=b,e.requestSync()},this.css=function(a,b){for(var c in b)e.saved.css.push([a,c,a.css(c)]),a.css(c,b[c])},this.scrollTop=function(a){return a===void 0?e.getScrollTop():e.setScrollTop(a)},BezierClass=function(a,b,c,d,e,f,g){this.st=a,this.ed=b,this.spd=c,this.p1=d||0,this.p2=e||1,this.p3=f||0,this.p4=g||1,this.ts=(new Date).getTime(),this.df=this.ed-this.st},BezierClass.prototype={B2:function(a){return 3*a*a*(1-a)},B3:function(a){return 3*a*(1-a)*(1-a)},B4:function(a){return(1-a)*(1-a)*(1-a)},getNow:function(){var a=(new Date).getTime(),b=1-(a-this.ts)/this.spd,c=this.B2(b)+this.B3(b)+this.B4(b);return 0>b?this.ed:this.st+Math.round(this.df*c)},update:function(a,b){return this.st=this.getNow(),this.ed=a,this.spd=b,this.ts=(new Date).getTime(),this.df=this.ed-this.st,this}},this.ishwscroll?(this.doc.translate={x:0,y:0},this.hastranslate3d&&this.doc.css(this.prefixstyle+"backface-visibility","hidden"),this.getScrollTop=function(a){return e.timerscroll&&!a?e.timerscroll.bz.getNow():e.doc.translate.y},this.notifyScrollEvent=document.createEvent?function(a){var b=document.createEvent("UIEvents");b.initUIEvent("scroll",!1,!0,window,1),a.dispatchEvent(b)}:document.fireEvent?function(a){var b=document.createEventObject();a.fireEvent("onscroll"),b.cancelBubble=!0}:function(){},this.setScrollTop=this.hastranslate3d?function(a,b){e.doc.css(e.trstyle,"translate3d(0px,"+a*-1+"px,0px)"),e.doc.translate.y=a,b||e.notifyScrollEvent(e.win[0])}:function(a,b){e.doc.css(e.trstyle,"translate(0px,"+a*-1+"px)"),e.doc.translate.y=a,b||e.notifyScrollEvent(e.win[0])}):(this.getScrollTop=function(){return e.docscroll.scrollTop()},this.setScrollTop=function(a){return e.docscroll.scrollTop(a)}),this.getTarget=function(a){return a?a.target?a.target:a.srcElement?a.srcElement:!1:!1},this.hasParent=function(a,b){if(!a)return!1;var c=a.target||a.srcElement||a||!1;while(c&&c.id!=b)c=c.parentNode||!1;return c!==!1};var s={thin:1,medium:3,thick:5};this.updateScrollBar=function(a){if(e.ishwscroll)e.rail.css({height:e.win.innerHeight()});else{var b=e.win.offset();b.top+=t(e.win,"border-top-width",!0),b.left+=e.win.outerWidth()-t(e.win,"border-right-width",!1)-e.rail.width;var c=e.opt.railoffset;c&&(c.top&&(b.top+=c.top),c.left&&(b.left+=c.left)),e.rail.css({top:b.top,left:b.left,height:a?a.h:e.win.innerHeight()}),e.zoom&&e.zoom.css({top:b.top+1,left:b.left-20})}},e.hasanimationframe=k,e.hascancelanimationframe=l,e.hasanimationframe?e.hascancelanimationframe||(l=function(){e.cancelAnimationFrame=!0}):(k=function(a){return setTimeout(a,16)},l=clearInterval),this.init=function(){function q(){e.iframexd=!1;try{var b="contentDocument"in this?this.contentDocument:this.contentWindow.document;b.domain}catch(a){e.iframexd=!0,b=!1}if(e.iframexd)return!0;if(e.isiframe&&(e.iframe={html:e.doc.contents().find("html")[0],body:e.doc.contents().find("body")[0]},e.getContentSize=function(){return{w:Math.max(e.iframe.html.scrollWidth,e.iframe.body.scrollWidth),h:Math.max(e.iframe.html.scrollHeight,e.iframe.body.scrollHeight)}},e.docscroll=h(this.contentWindow)),e.opt.iframeautoresize&&!e.isiframe){e.win.scrollTop(0),e.doc.height("");var d=Math.max(b.getElementsByTagName("html")[0].scrollHeight,b.body.scrollHeight);e.doc.height(d)}e.resize(),e.isie7&&e.css(h(b).find("html"),{"overflow-y":"hidden"}),e.css(h(b.body),{"overflow-y":"hidden"}),"contentWindow"in this?e.bind(this.contentWindow,"scroll",e.onscroll):e.bind(b,"scroll",e.onscroll),e.bind(b,"mouseup",e.onmouseup),e.bind(b,"mousewheel",e.onmousewheel),e.bind(b,e.isopera?"keypress":"keydown",e.onkeypress),(e.cantouch||e.opt.touchbehavior)&&(e.bind(b,"mousedown",e.onmousedown),e.cursorgrabvalue&&e.css(h(b.body),{cursor:e.cursorgrabvalue})),e.bind(b,"mousemove",e.onmousemove),e.zoom&&(e.opt.dblclickzoom&&e.bind(b,"dblclick",e.doZoom),e.ongesturezoom&&e.bind(b,"gestureend",e.ongesturezoom))}if(e.saved.css=[],e.isie7mobile)return!0;if(e.hasmstouch&&e.css(e.ispage?h("html"):e.win,{"-ms-touch-action":"none"}),!e.ispage||!e.cantouch&&!e.isieold&&!e.isie9mobile){var a=e.docscroll;e.ispage&&(a=e.haswrapper?e.win:e.doc),e.isie9mobile||e.css(a,{"overflow-y":"hidden"}),e.ispage&&e.isie7&&e.win[0].nodeName=="BODY"&&e.css(h("html"),{"overflow-y":"hidden"});var b=h(document.createElement("div"));b.css({position:"relative",top:0,"float":"right",width:e.opt.cursorwidth,height:"0px","background-color":e.opt.cursorcolor,border:e.opt.cursorborder,"background-clip":"padding-box","-webkit-border-radius":e.opt.cursorborderradius,"-moz-border-radius":e.opt.cursorborderradius,"border-radius":e.opt.cursorborderradius}),b.hborder=parseFloat(b.outerHeight()-b.innerHeight()),e.cursor=b;var g=h(document.createElement("div"));g.attr("id",e.id),g.width=Math.max(parseFloat(e.opt.cursorwidth),b.outerWidth()),g.css({width:g.width+"px",zIndex:e.ispage?e.opt.zindex:e.opt.zindex+2,background:e.opt.background});var i=["top","bottom","left","right"];for(var k in i){var l=e.opt.railpadding[k];l&&g.css("padding-"+k,l+"px")}g.append(b),e.rail=g,e.rail.drag=!1;var m=!1;if(!e.opt.boxzoom||e.ispage||e.isieold||(m=document.createElement("div"),e.bind(m,"click",e.doZoom),e.zoom=h(m),e.zoom.css({cursor:"pointer","z-index":e.opt.zindex,backgroundImage:"url("+j+"zoomico.png)",height:18,width:18,backgroundPosition:"0px 0px"}),e.opt.dblclickzoom&&e.bind(e.win,"dblclick",e.doZoom),e.cantouch&&e.opt.gesturezoom&&(e.ongesturezoom=function(a){return a.scale>1.5&&e.doZoomIn(a),.8>a.scale&&e.doZoomOut(a),e.cancelEvent(a)},e.bind(e.win,"gestureend",e.ongesturezoom))),e.ispage)g.css({position:"fixed",top:"0px",right:"0px",height:"100%"}),e.body.append(g);else{if(e.ishwscroll){e.win.css("position")=="static"&&e.css(e.win,{position:"relative"});var o=e.win[0].nodeName=="HTML"?e.body:e.win;e.zoom&&(e.zoom.css({position:"absolute",top:1,right:0,"margin-right":g.width+4}),o.append(e.zoom)),g.css({position:"absolute",top:0,right:0}),o.append(g)}else g.css({position:"absolute"}),e.zoom&&e.zoom.css({position:"absolute"}),e.updateScrollBar(),e.body.append(g),e.zoom&&e.body.append(e.zoom);e.isios&&e.css(e.win,{"-webkit-tap-highlight-color":"rgba(0,0,0,0)","-webkit-touch-callout":"none"})}if(e.opt.autohidemode===!1?e.autohidedom=!1:e.opt.autohidemode===!0?e.autohidedom=e.rail:e.opt.autohidemode=="cursor"&&(e.autohidedom=e.cursor),e.isie9mobile){e.scrollmom={y:new n(e)},e.onmangotouch=function(){var b=e.getScrollTop();if(b==e.scrollmom.y.lastscrolly)return!0;var c=b-e.mangotouch.sy;if(c!=0){var d=0>c?-1:1,f=(new Date).getTime();if(e.mangotouch.lazy&&clearTimeout(e.mangotouch.lazy),f-e.mangotouch.tm>60||e.mangotouch.dry!=d)e.scrollmom.y.stop(),e.scrollmom.y.reset(b),e.mangotouch.sy=b,e.mangotouch.ly=b,e.mangotouch.dry=d,e.mangotouch.tm=f;else{e.scrollmom.y.stop(),e.scrollmom.y.update(e.mangotouch.sy-c);var g=f-e.mangotouch.tm;e.mangotouch.tm=f;var h=Math.abs(e.mangotouch.ly-b);e.mangotouch.ly=b,h>2&&(e.mangotouch.lazy=setTimeout(function(){e.mangotouch.lazy=!1,e.mangotouch.dry=0,e.mangotouch.tm=0,e.scrollmom.y.doMomentum(g)},80))}}};var p=e.getScrollTop();e.mangotouch={sy:p,ly:p,dry:0,lazy:!1,tm:0},e.bind(e.docscroll,"scroll",e.onmangotouch)}else(e.cantouch||e.opt.touchbehavior||e.hasmstouch)&&(e.scrollmom={y:new n(e)},e.ontouchstart=function(a){if(a.pointerType&&a.pointerType!=2)return!1;if(!e.locked){if(e.hasmstouch){var b=a.target?a.target:!1;while(b){var c=h(b).getNiceScroll();if(c.length>0&&c[0].me==e.me)break;if(c.length>0)return!1;if(b.nodeName=="DIV"&&b.id==e.id)break;b=b.parentNode?b.parentNode:!1}}if(e.cancelScroll(),e.rail.drag={x:a.clientX,y:a.clientY,sx:e.scroll.x,sy:e.scroll.y,st:e.getScrollTop(),pt:2},e.hasmoving=!1,e.lastmouseup=!1,e.scrollmom.y.reset(a.clientY),!e.cantouch&&!e.hasmstouch){var b=e.getTarget(a),d=b?/INPUT|SELECT|TEXTAREA/i.test(b.nodeName):!1;if(!d)return e.cancelEvent(a);/SUBMIT|CANCEL|BUTTON/i.test(h(b).attr("type"))&&(pc={tg:b,click:!1},e.preventclick=pc)}}},e.ontouchend=function(a){return a.pointerType&&a.pointerType!=2?!1:e.rail.drag&&e.rail.drag.pt==2&&(e.scrollmom.y.doMomentum(),e.rail.drag=!1,e.hasmoving&&(e.hasmoving=!1,e.lastmouseup=!0,e.hideCursor(),!e.cantouch))?e.cancelEvent(a):void 0},e.ontouchmove=function(a){if(a.pointerType&&a.pointerType!=2)return!1;if(e.rail.drag&&e.rail.drag.pt==2){if(e.cantouch&&a.original===void 0)return!0;e.hasmoving=!0,e.preventclick&&!e.preventclick.click&&(e.preventclick.click=e.preventclick.tg.onclick||!1,e.preventclick.tg.onclick=e.onpreventclick);var b=a.clientY,c=b-e.rail.drag.y,d=e.rail.drag.st-c;return e.ishwscroll?0>d?(d=Math.round(d/2),b=0):d>e.page.maxh&&(d=e.page.maxh+Math.round((d-e.page.maxh)/2),b=0):(0>d&&(d=0),d>e.page.maxh&&(d=e.page.maxh)),e.synched("touchmove",function(){e.rail.drag&&e.rail.drag.pt==2&&(e.prepareTransition&&e.prepareTransition(0),e.setScrollTop(d),e.showCursor(d),e.scrollmom.y.update(b))}),e.cancelEvent(a)}}),e.cantouch||e.opt.touchbehavior?(e.onpreventclick=function(a){return e.preventclick?(e.preventclick.tg.onclick=e.preventclick.click,e.preventclick=!1,e.cancelEvent(a)):void 0},e.onmousedown=e.ontouchstart,e.onmouseup=e.ontouchend,e.onclick=e.isios?!1:function(a){return e.lastmouseup?(e.lastmouseup=!1,e.cancelEvent(a)):!0},e.onmousemove=e.ontouchmove,e.cursorgrabvalue&&(e.css(e.ispage?e.doc:e.win,{cursor:e.cursorgrabvalue}),e.css(e.rail,{cursor:e.cursorgrabvalue}))):(e.onmousedown=function(a){return e.rail.drag&&e.rail.drag.pt!=1?void 0:e.locked?e.cancelEvent(a):(e.cancelScroll(),e.rail.drag={x:a.clientX,y:a.clientY,sx:e.scroll.x,sy:e.scroll.y,pt:1},e.cancelEvent(a))},e.onmouseup=function(a){if(e.rail.drag){if(e.rail.drag.pt!=1)return;return e.rail.drag=!1,e.cancelEvent(a)}},e.onmousemove=function(a){if(e.rail.drag){if(e.rail.drag.pt!=1)return;e.scroll.y=e.rail.drag.sy+(a.clientY-e.rail.drag.y),0>e.scroll.y&&(e.scroll.y=0);var b=e.scrollvaluemax;return e.scroll.y>b&&(e.scroll.y=b),e.synched("mousemove",function(){e.rail.drag&&e.rail.drag.pt==1&&(e.showCursor(),e.cursorfreezed=!0,e.doScroll(Math.round(e.scroll.y*e.scrollratio.y)))}),e.cancelEvent(a)}e.checkarea=!0}),(e.cantouch||e.opt.touchbehavior)&&e.bind(e.win,"mousedown",e.onmousedown),e.hasmstouch&&(e.css(e.rail,{"-ms-touch-action":"none"}),e.css(e.cursor,{"-ms-touch-action":"none"}),e.bind(e.win,"MSPointerDown",e.ontouchstart),e.bind(document,"MSPointerUp",e.ontouchend),e.bind(document,"MSPointerMove",e.ontouchmove),e.bind(e.cursor,"MSGestureHold",function(a){a.preventDefault()}),e.bind(e.cursor,"contextmenu",function(a){a.preventDefault()})),e.bind(e.cursor,"mousedown",e.onmousedown),e.bind(e.cursor,"mouseup",function(a){return e.rail.drag&&e.rail.drag.pt==2?void 0:(e.rail.drag=!1,e.hasmoving=!1,e.hideCursor(),e.cancelEvent(a))}),e.bind(document,"mouseup",e.onmouseup),e.bind(document,"mousemove",e.onmousemove),e.onclick&&e.bind(document,"click",e.onclick),e.cantouch||(e.rail.mouseenter(function(){e.showCursor(),e.rail.active=!0}),e.rail.mouseleave(function(){e.rail.active=!1,e.rail.drag||e.hideCursor()}),e.isiframe||e.bind(e.isie&&e.ispage?document:e.docscroll,"mousewheel",e.onmousewheel),e.bind(e.rail,"mousewheel",e.onmousewheel)),e.zoom&&(e.zoom.mouseenter(function(){e.showCursor(),e.rail.active=!0}),e.zoom.mouseleave(function(){e.rail.active=!1,e.rail.drag||e.hideCursor()})),e.ispage||e.cantouch||/HTML|BODY/.test(e.win[0].nodeName)||(e.win.attr("tabindex")||e.win.attr({tabindex:f++}),e.ischrome&&e.opt.disableoutline&&e.win.css({outline:"none"}),e.win.focus(function(a){c=e.getTarget(a).id||!0,e.hasfocus=!0,e.noticeCursor()}),e.win.blur(function(){c=!1,e.hasfocus=!1}),e.win.mouseenter(function(a){d=e.getTarget(a).id||!0,e.hasmousefocus=!0,e.noticeCursor()}),e.win.mouseleave(function(){d=!1,e.hasmousefocus=!1}));e.onkeypress=function(a){if(e.locked&&e.page.maxh==0)return!0;a=a?a:window.e;var b=e.getTarget(a);if(b&&/INPUT|TEXTAREA|SELECT|OPTION/.test(b.nodeName)){var f=b.getAttribute("type")||b.type||!1;if(!f||!/submit|button|cancel/i.tp)return!0}if(e.hasfocus||e.hasmousefocus&&!c||e.ispage&&!c&&!d){var g=a.keyCode;if(e.locked&&g!=27)return e.cancelEvent(a);var h=!1;switch(g){case 38:case 63233:e.doScrollBy(72),h=!0;break;case 40:case 63235:e.doScrollBy(-72),h=!0;break;case 33:case 63276:e.doScrollBy(e.view.h),h=!0;break;case 34:case 63277:e.doScrollBy(-e.view.h),h=!0;break;case 36:case 63273:e.doScrollTo(0),h=!0;break;case 35:case 63275:e.doScrollTo(e.page.maxh),h=!0;break;case 32:e.opt.spacebarenabled&&(e.doScrollBy(-e.view.h),h=!0);break;case 27:e.zoomactive&&(e.doZoom(),h=!0)}if(h)return e.cancelEvent(a)}},e.bind(document,e.isopera?"keypress":"keydown",e.onkeypress),e.bind(window,"resize",e.resize),e.bind(window,"orientationchange",e.resize),e.bind(window,"load",e.resize),e.onAttributeChange=function(){e.lazyResize()},e.ispage||e.haswrapper||("WebKitMutationObserver"in window?(e.observer=new WebKitMutationObserver(function(a){a.forEach(e.onAttributeChange)}),e.observer.observe(e.win[0],{attributes:!0,subtree:!1})):(e.bind(e.win,e.isie&&!e.isie9?"propertychange":"DOMAttrModified",e.onAttributeChange),e.isie9&&e.win[0].attachEvent("onpropertychange",e.onAttributeChange))),!e.ispage&&e.opt.boxzoom&&e.bind(window,"resize",e.resizeZoom),e.istextarea&&e.bind(e.win,"mouseup",e.resize),e.resize()}this.doc[0].nodeName=="IFRAME"&&(this.doc[0].readyState&&this.doc[0].readyState=="complete"&&setTimeout(function(){q.call(e.doc[0],!1)},500),e.bind(this.doc,"load",q))},this.showCursor=function(a){e.cursortimeout&&(clearTimeout(e.cursortimeout),e.cursortimeout=0),e.rail&&(e.autohidedom&&e.autohidedom.stop().css({opacity:e.opt.cursoropacitymax}),a!==void 0&&(e.scroll.y=Math.round(a*1/e.scrollratio.y)),e.cursor.css({height:e.cursorheight,top:e.scroll.y}),e.zoom&&e.zoom.stop().css({opacity:e.opt.cursoropacitymax}))},this.hideCursor=function(a){e.cursortimeout||e.rail&&e.autohidedom&&(e.cursortimeout=setTimeout(function(){e.rail.active||(e.autohidedom.stop().animate({opacity:e.opt.cursoropacitymin}),e.zoom&&e.zoom.stop().animate({opacity:e.opt.cursoropacitymin})),e.cursortimeout=0},a||400))},this.noticeCursor=function(a,b){e.showCursor(b),e.hideCursor(a)},this.getContentSize=e.ispage?function(){return{w:Math.max(document.body.scrollWidth,document.documentElement.scrollWidth),h:Math.max(document.body.scrollHeight,document.documentElement.scrollHeight)}}:e.haswrapper?function(){return{w:e.doc.outerWidth()+parseInt(e.win.css("paddingLeft"))+parseInt(e.win.css("paddingRight")),h:e.doc.outerHeight()+parseInt(e.win.css("paddingTop"))+parseInt(e.win.css("paddingBottom"))}}:function(){return{w:e.docscroll[0].scrollWidth,h:e.docscroll[0].scrollHeight}},this.onResize=function(a,b){if(e.rail==0)return!1;if(!e.haswrapper&&!e.ispage){if(e.win.css("display")=="none")return e.visibility&&e.hideRail(),!1;e.visibility||e.getScrollTop()!=0||e.doScrollTo(Math.floor(e.scroll.y*e.scrollratio.y)),e.hidden||e.visibility||e.showRail()}var c=e.page.maxh,d=e.page.maxw,f={h:e.view.h,w:e.view.w};if(e.view={w:e.ispage?e.win.width():parseInt(e.win[0].clientWidth),h:e.ispage?e.win.height():parseInt(e.win[0].clientHeight)},e.page=b?b:e.getContentSize(),e.page.maxh=Math.max(0,e.page.h-e.view.h),e.page.maxw=Math.max(0,e.page.w-e.view.w),e.page.maxh==c&&e.page.maxw==d&&e.view.w==f.w){if(e.ispage)return e;var g=e.win.offset();if(e.lastposition){var h=e.lastposition;if(h.top==g.top&&h.left==g.left)return e}e.lastposition=g}if(e.page.maxh==0)return e.hideRail(),e.scrollvaluemax=0,e.scroll.y=0,e.scrollratio={x:0,y:0},e.cursorheight=0,e.locked=!0,e.setScrollTop(0),!1;e.hidden||e.visibility||(e.showRail(),e.locked=!1),e.istextarea&&e.win.css("resize")&&e.win.css("resize")!="none"&&(e.view.h-=20),e.ispage||e.updateScrollBar(e.view),e.cursorheight=Math.min(e.view.h,Math.round(e.view.h*(e.view.h/e.page.h))),e.cursorheight=Math.max(e.opt.cursorminheight,e.cursorheight),e.scrollvaluemax=e.view.h-e.cursorheight-e.cursor.hborder,e.scrollratio={x:0,y:e.page.maxh/e.scrollvaluemax};var i=e.getScrollTop();return i>e.page.maxh?e.doScroll(e.page.maxh):(e.scroll.y=Math.round(e.getScrollTop()*(1/e.scrollratio.y)),e.noticeCursor()),e},this.resize=this.onResize,this.lazyResize=function(){e.delayed("resize",e.resize,250)},this._bind=function(a,b,c,d){e.events.push({e:a,n:b,f:c}),a.addEventListener?a.addEventListener(b,c,d||!1):a.attachEvent?a.attachEvent("on"+b,c):a["on"+b]=c},this.bind=function(a,b,c,d){var f="jquery"in a?a[0]:a;if(f.addEventListener){if(e.cantouch&&/mouseup|mousedown|mousemove/.test(b)){var g=b=="mousedown"?"touchstart":b=="mouseup"?"touchend":"touchmove";e._bind(f,g,function(a){if(a.touches){if(2>a.touches.length){var b=a.touches.length?a.touches[0]:a;b.original=a,c.call(this,b)}}else if(a.changedTouches){var b=a.changedTouches[0];b.original=a,c.call(this,b)}},d||!1)}e._bind(f,b,c,d||!1),b=="mousewheel"&&e._bind(f,"DOMMouseScroll",c,d||!1),e.cantouch&&b=="mouseup"&&e._bind(f,"touchcancel",c,d||!1)}else e._bind(f,b,function(a){return a=a||window.event||!1,a&&a.srcElement&&(a.target=a.srcElement),c.call(f,a)===!1||d===!1?e.cancelEvent(a):!0})},this._unbind=function(a,b,c){a.removeEventListener?a.removeEventListener(b,c,!1):a.detachEvent?a.detachEvent("on"+b,c):a["on"+b]=!1},this.unbindAll=function(){for(var a=0;e.events.length>a;a++){var b=e.events[a];e._unbind(b.e,b.n,b.f)}},this.cancelEvent=function(a){var a=a.original?a.original:a?a:window.event||!1;return a?(a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.preventManipulation&&a.preventManipulation(),a.cancelBubble=!0,a.cancel=!0,a.returnValue=!1,!1):!1},this.showRail=function(){return e.page.maxh==0||!e.ispage&&e.win.css("display")=="none"||(e.visibility=!0,e.rail.css("display","block")),e},this.hideRail=function(){return e.visibility=!1,e.rail.css("display","none"),e},this.show=function(){return e.hidden=!1,e.locked=!1,e.showRail()},this.hide=function(){return e.hidden=!0,e.locked=!0,e.hideRail()},this.remove=function(){e.doZoomOut(),e.unbindAll(),e.observer!==!1&&e.observer.disconnect(),e.events=[],e.rail.remove(),e.zoom&&e.zoom.remove(),e.cursor=!1,e.rail=!1,e.zoom=!1;for(var a=0;e.saved.css.length>a;a++){var b=e.saved.css[a];b[0].css(b[1],b[2]===void 0?"":b[2])}return e.saved=!1,e.me.data("__nicescroll",""),e},this.isScrollable=function(a){var b=a.target?a.target:a;while(b&&b.nodeName&&!/BODY|HTML/.test(b.nodeName)){var c=h(b),d=c.css("overflowY")||c.css("overflow")||"";if(/scroll|auto/.test(d))return b.clientHeight!=b.scrollHeight;b=b.parentNode?b.parentNode:!1}return!1},this.onmousewheel=function(a){if(e.locked&&e.page.maxh==0)return!0;if(e.opt.preservenativescrolling&&e.checkarea&&(e.checkarea=!1,e.nativescrollingarea=e.isScrollable(a)),e.nativescrollingarea)return!0;if(e.locked)return e.cancelEvent(a);if(e.rail.drag)return e.cancelEvent(a);var b=0,b=a.detail?a.detail*-1:a.wheelDelta/40;return b&&(e.scrollmom&&e.scrollmom.y.stop(),e.lastdelta+=b*e.opt.mousescrollstep,e.synched("mousewheel",function(){if(!e.rail.drag){var a=e.lastdelta;e.lastdelta=0,e.doScrollBy(a)}})),e.cancelEvent(a)},this.stop=function(){return e.cancelScroll(),e.scrollmon&&e.scrollmon.stop(),e.cursorfreezed=!1,e.scroll.y=Math.round(e.getScrollTop()*(1/e.scrollratio.y)),e.noticeCursor(),e},e.ishwscroll&&e.hastransition&&e.opt.usetransition?(this.prepareTransition=function(a){var c=Math.round(e.opt.scrollspeed*10),d=Math.min(c,Math.round(a/20*e.opt.scrollspeed)),f=d>20?e.prefixstyle+"transform "+d+"ms ease-out 0s":"";return e.lasttransitionstyle&&e.lasttransitionstyle==f||(e.lasttransitionstyle=f,e.doc.css(e.transitionstyle,f)),d},this.doScroll=function(a,b){var c=e.getScrollTop();return 0>a&&0>=c?e.noticeCursor():a>e.page.maxh&&c>=e.page.maxh?(e.checkContentSize(),e.noticeCursor()):(e.newscrolly=a,e.newscrollspeed=b||!1,e.timer?!1:(e.scrollendtrapped||(e.scrollendtrapped=!0,e.bind(e.doc,e.transitionend,e.onScrollEnd,!1)),e.timer=setTimeout(function(){var a=e.getScrollTop(),b=e.newscrollspeed?e.newscrollspeed:Math.abs(a-e.newscrolly),c=e.prepareTransition(b);e.timer=setTimeout(function(){if(0>e.newscrolly&&!e.opt.bouncescroll?e.newscrolly=0:e.newscrolly>e.page.maxh&&!e.opt.bouncescroll&&(e.newscrolly=e.page.maxh),e.newscrolly==e.getScrollTop())e.timer=0,e.onScrollEnd();else{var a=e.getScrollTop();e.timerscroll&&e.timerscroll.tm&&clearInterval(e.timerscroll.tm),c>0&&(e.timerscroll={ts:(new Date).getTime(),s:e.getScrollTop(),e:e.newscrolly,sp:c,bz:new BezierClass(a,e.newscrolly,c,0,1,0,1)},e.cursorfreezed||(e.timerscroll.tm=setInterval(function(){e.showCursor(e.getScrollTop())},60))),e.setScrollTop(e.newscrolly),e.timer=0}},15)},e.opt.scrollspeed),void 0))},this.cancelScroll=function(){if(!e.scrollendtrapped)return!0;var a=e.getScrollTop();return e.scrollendtrapped=!1,e._unbind(e.doc,e.transitionend,e.onScrollEnd),e.prepareTransition(0),e.setScrollTop(a),e.timerscroll&&e.timerscroll.tm&&clearInterval(e.timerscroll.tm),e.timerscroll=!1,e.cursorfreezed=!1,e.noticeCursor(!1,a),e},this.onScrollEnd=function(){e.scrollendtrapped=!1,e._unbind(e.doc,e.transitionend,e.onScrollEnd),e.timerscroll&&e.timerscroll.tm&&clearInterval(e.timerscroll.tm),e.timerscroll=!1,e.cursorfreezed=!1;var a=e.getScrollTop();e.setScrollTop(a),e.noticeCursor(!1,a),0>a?e.doScroll(0,60):a>e.page.maxh&&e.doScroll(e.page.maxh,60)}):(this.doScroll=function(a){function g(){if(e.cancelAnimationFrame)return!0;if(f=1-f)return e.timer=k(g)||1;var a=e.getScrollTop(),b=e.bzscroll?e.bzscroll.getNow():e.newscrolly,c=b-a;(0>c&&e.newscrolly>b||c>0&&b>e.newscrolly)&&(b=e.newscrolly),e.setScrollTop(b),b==e.newscrolly?(e.timer=0,e.cursorfreezed=!1,e.bzscroll=!1,0>b?e.doScroll(0):b>e.page.maxh&&e.doScroll(e.page.maxh)):e.timer=k(g)||1}if(e.newscrolly==a)return!0;var b=e.getScrollTop();e.newscrolly=a,e.bouncescroll||(0>e.newscrolly?(e.newspeedy&&(e.newspeedy.x=0),e.newscrolly=0):e.newscrolly>e.page.maxh&&(e.newspeedy&&(e.newspeedy.x=e.page.maxh),e.newscrolly=e.page.maxh));var c=Math.floor(Math.abs(a-b)/40);if(c>0){var d=Math.min(10,c)*100;e.bzscroll=e.bzscroll?e.bzscroll.update(a,d):new BezierClass(b,a,d,0,1,0,1)}else e.bzscroll=!1;if(!e.timer){b==e.page.maxh&&a>=e.page.maxh&&e.checkContentSize();var f=1;e.cancelAnimationFrame=!1,e.timer=1,g(),b==e.page.maxh&&a>=b&&e.checkContentSize(),e.noticeCursor()}},this.cancelScroll=function(){return e.timer&&l(e.timer),e.timer=0,e.bzscroll=!1,e}),this.doScrollBy=function(a,b){var c=0;if(b)c=Math.floor((e.scroll.y-a)*e.scrollratio.y);else{var d=e.timer?e.newscrolly:e.getScrollTop(!0);c=d-a}if(e.bouncescroll){var f=Math.round(e.view.h/2);-f>c?c=-f:c>e.page.maxh+f&&(c=e.page.maxh+f)}e.cursorfreezed=!1,e.doScroll(c)},this.doScrollTo=function(a,b){var c=b?Math.round(a*e.scrollratio.y):a;0>c?c=0:c>e.page.maxh&&(c=e.page.maxh),e.cursorfreezed=!1,e.doScroll(a)},this.checkContentSize=function(){var a=e.getContentSize();a.h!=e.page.h&&e.resize(!1,a)},e.onscroll=function(){e.rail.drag||e.cursorfreezed||e.synched("scroll",function(){e.scroll.y=Math.round(e.getScrollTop()*(1/e.scrollratio.y)),e.noticeCursor()})},e.bind(e.docscroll,"scroll",e.onscroll),this.doZoomIn=function(a){if(!e.zoomactive){e.zoomactive=!0,e.zoomrestore={style:{}};var b=["position","top","left","zIndex","backgroundColor","marginTop","marginBottom","marginLeft","marginRight"],c=e.win[0].style;for(var d in b){var f=b[d];e.zoomrestore.style[f]=c[f]!==void 0?c[f]:""}e.zoomrestore.style.width=e.win.css("width"),e.zoomrestore.style.height=e.win.css("height"),e.zoomrestore.padding={w:e.win.outerWidth()-e.win.width(),h:e.win.outerHeight()-e.win.height()},e.isios4&&(e.zoomrestore.scrollTop=h(window).scrollTop(),h(window).scrollTop(0)),e.win.css({position:e.isios4?"absolute":"fixed",top:0,left:0,"z-index":e.opt.zindex+100,margin:"0px"});var g=e.win.css("backgroundColor");return(g==""||/transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(g))&&e.win.css("backgroundColor","#fff"),e.rail.css({"z-index":e.opt.zindex+110}),e.zoom.css({"z-index":e.opt.zindex+112}),e.zoom.css("backgroundPosition","0px -18px"),e.resizeZoom(),e.cancelEvent(a)}},this.doZoomOut=function(a){return e.zoomactive?(e.zoomactive=!1,e.win.css("margin",""),e.win.css(e.zoomrestore.style),e.isios4&&h(window).scrollTop(e.zoomrestore.scrollTop),e.rail.css({"z-index":e.ispage?e.opt.zindex:e.opt.zindex+2}),e.zoom.css({"z-index":e.opt.zindex}),e.zoomrestore=!1,e.zoom.css("backgroundPosition","0px 0px"),e.onResize(),e.cancelEvent(a)):void 0},this.doZoom=function(a){return e.zoomactive?e.doZoomOut(a):e.doZoomIn(a)},this.resizeZoom=function(){if(e.zoomactive){var a=e.getScrollTop();e.win.css({width:h(window).width()-e.zoomrestore.padding.w+"px",height:h(window).height()-e.zoomrestore.padding.h+"px"}),e.onResize(),e.setScrollTop(Math.min(e.page.maxh,a))}},this.init(),h.nicescroll.push(this)},n=function(a){var b=this;this.nc=a,this.lasty=0,this.speedy=0,this.lasttime=0,this.snapy=!1,this.demuly=0,this.lastscrolly=-1,this.chky=0,this.timer=0,this.time=function(){return(new Date).getTime()},this.reset=function(a){b.stop(),b.lasttime=b.time(),b.speedy=0,b.lasty=a,b.lastscrolly=-1},this.update=function(c){b.lasttime=b.time();var d=c-b.lasty,e=a.getScrollTop(),f=e+d;b.snapy=0>f||f>b.nc.page.maxh,b.speedy=d,b.lasty=c},this.stop=function(){b.timer&&(clearTimeout(b.timer),b.timer=0,b.lastscrolly=-1)},this.doSnapy=function(a){0>a?b.nc.doScroll(0,60):a>b.nc.page.maxh&&b.nc.doScroll(b.nc.page.maxh,60)},this.doMomentum=function(a){var c=b.time(),d=a?c+a:b.lasttime;b.speedy=Math.min(60,b.speedy);var e=d&&50>=c-d,f=b.speedy&&e?b.speedy:!1;if(f){var a=c-d,g=b.nc.page.maxh;b.demuly=0,b.lastscrolly=b.nc.getScrollTop(),b.chky=b.lastscrolly;var h=function(){var c=Math.floor(b.lastscrolly-b.speedy*(1-b.demuly));b.demuly+=0>c||c>g?.08:.01,b.lastscrolly=c,b.nc.synched("domomentum",function(){var a=b.nc.getScrollTop();a!=b.chky&&b.stop(),b.chky=c,b.nc.setScrollTop(c),b.timer?b.nc.showCursor(c):(b.nc.hideCursor(),b.doSnapy(c))}),b.timer=1>b.demuly?setTimeout(h,a):0};h()}else b.snapy&&b.doSnapy(b.nc.getScrollTop())}},o=b.fn.scrollTop;h.cssHooks.scrollTop={get:function(a){var d=h.data(a,"__nicescroll")||!1;return d&&d.ishwscroll?d.getScrollTop():o.call(a)},set:function(a,b){var c=h.data(a,"__nicescroll")||!1;return c&&c.ishwscroll?c.setScrollTop(parseInt(b)):o.call(a,b),this}},b.fn.scrollTop=function(a){if(a===void 0){var b=this[0]?h.data(this[0],"__nicescroll")||!1:!1;return b&&b.ishwscroll?b.getScrollTop():o.call(this)}return this.each(function(){var b=h.data(this,"__nicescroll")||!1;b&&b.ishwscroll?b.setScrollTop(parseInt(a)):o.call(h(this),a)})};var p=function(b){var c=this;if(this.length=0,this.name="nicescrollarray",this.each=function(a){for(var b=0;c.length>b;b++)a.call(c[b]);return c},this.push=function(a){c[c.length]=a,c.length++},this.eq=function(a){return c[a]},b)for(a=0;b.length>a;a++){var d=h.data(b[a],"__nicescroll")||!1;d&&(this[this.length]=d,this.length++)}return this};q(p.prototype,["show","hide","onResize","resize","remove","stop"],function(a,b){a[b]=function(){return this.each(function(){this[b].call()})}}),b.fn.getNiceScroll=function(a){if(a===void 0)return new p(this);var b=h.data(this[a],"__nicescroll")||!1;return b},b.extend(b.expr[":"],{nicescroll:function(a){return h.data(a,"__nicescroll")?!0:!1}}),h.fn.niceScroll=function(a,b){b===void 0&&(typeof a!="object"||"jquery"in a||(b=a,a=!1));var c=new p;b===void 0&&(b={}),a&&(b.doc=h(a),b.win=h(this));var d=!("doc"in b);return d||"win"in b||(b.win=h(this)),this.each(function(){var a=h(this).data("__nicescroll")||!1;a||(b.doc=d?h(this):b.doc,a=new m(b,h(this)),h(this).data("__nicescroll",a)),c.push(a)}),c.length==1?c[0]:c},window.NiceScroll={getjQuery:function(){return b}},h.nicescroll||(h.nicescroll=new p)})(jQuery);
